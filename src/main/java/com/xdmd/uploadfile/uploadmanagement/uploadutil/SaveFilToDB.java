package com.xdmd.uploadfile.uploadmanagement.uploadutil;
 ...
 * 把上传文件的属性存储起来 保存到数据中
 */
public class SaveFilToDB {

    public static UploadFile IntegrationFile(MultipartFile file, String filePath, String fileType, String createName) {
        UploadFile uploadFile = new UploadFile();
        uploadFile.setUploadFilePath(filePath);
        //获取文件名
